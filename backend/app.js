								...
								stats: {
									[schemaID]: {
										...
										openSum: db.r
											...
											.default(0)
											.add(results.changes[0].new_val.item.suggested_price),
									},
								},
								canChat: true,
							})
								...
								return row.branch(
									{
										...
										value: row('value').add(results.changes[0].new_val.item.suggested_price),
										topDay: row('topDay')
											.append(pl)
									...
									},
									{
										date,
										amount: 1,
										value: results.changes[0].new_val.item.suggested_price,
										topDay: [pl],
										revenue: 0,
									}
								)
